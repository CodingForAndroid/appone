...
public class MediaController extends FrameLayout {
  ...
  private ImageButton mChangeSize;
  ...
  public MediaController(Context context,Controller controller) {
    super(context);
  ...
  private void initControllerView(View v) {
    ...
    mBackButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_ib_back", "id", mContext.getPackageName()));
    mShareButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_ib_share", "id", mContext.getPackageName()));
    mChangeSize = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_ib_changesize", "id", mContext.getPackageName()));
    ...
    if (mBackButton != null) {
      ...
      mBackButton.setOnClickListener(mController.getBackClickListener());
    }
    if (mShareButton != null) {
      mShareButton.requestFocus();
      mShareButton.setOnClickListener(mController.getShareClickListener());
    }
    if(mChangeSize!=null){
      mChangeSize.requestFocus();
      mChangeSize.setOnClickListener(mController.selectedSizeListener(mChangeSize));
    }
    ...
    RelativeLayout  mParentLayout = (RelativeLayout) v.findViewById(getResources().getIdentifier("rl_parent", "id", mContext.getPackageName()));

    RelativeLayout  mTopLayout = (RelativeLayout) v.findViewById(getResources().getIdentifier("rl_top", "id", mContext.getPackageName()));
    RelativeLayout   mBottomLayout = (RelativeLayout) v.findViewById(getResources().getIdentifier("rl_bottom", "id", mContext.getPackageName()));
    OnClickListener clickListener=new OnClickListener() {
      @Override
      public void onClick(View view) {
        if(view.getId()== R.id.rl_top){
//          Log.e("OnClickListener","上面");
        }else if(view.getId()==R.id.rl_bottom){
//          Log.e("OnClickListener","下面");

        }else if(view.getId()==R.id.rl_parent){
//          Log.e("OnClickListener","中间");

        }
      }
    };
    mParentLayout.requestFocus();
    mBottomLayout.requestFocus();
    mTopLayout.requestFocus();

    mParentLayout.setOnClickListener(clickListener);
    mBottomLayout.setOnClickListener(clickListener);
    mTopLayout.setOnClickListener(clickListener);
  ...
  public interface  Controller{
    ...
    OnClickListener getShareClickListener();
    //后退点击事件
    OnClickListener getBackClickListener();
    //  击改变屏幕大小
    OnClickListener selectedSizeListener(ImageButton mChangeSize);
  }
}
