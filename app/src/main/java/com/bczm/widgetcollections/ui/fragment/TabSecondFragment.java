    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case  R.id.comm_id_01: // 香港卫视
                ...
                intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_HK);
//                intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, "http://officetv.bupt.edu.cn/hls/cctv5hd.m3u8");
            ...
            case  R.id.comm_id_02: // CIBN 经典影视
                 intent=    new Intent(getActivity(), VideoPlayerActivity.class);
                intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_CIBN);
                break;
            case  R.id.comm_id_03: //华视HD
                 intent=    new Intent(getActivity(), VideoPlayerActivity.class);
                intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_HSHD);
                break;
            case  R.id.comm_id_04: // Fox 台
                 intent=    new Intent(getActivity(), VideoPlayerActivity.class);
             intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_FOX);
                break;
            case  R.id.comm_id_05: // 橙子影院
                 intent=    new Intent(getActivity(), VideoPlayerActivity.class);
             intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_CZYS);
                break;
            case  R.id.comm_id_06: // 泰国中文台
                 intent=    new Intent(getActivity(), VideoPlayerActivity.class);
             intent.putExtra(Constants.INTENT_BUNDLE_KEY_CHANNEL, ConfigManage.CHANNEL_TAI);
                break;
        }
